...
.avatar-circle { width: 120px; height: 120px; background: white; border: 4px solid white; border-radius: 50%; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.15); display: flex; align-items: center; justify-content: center; cursor: pointer; transition: all 0.2s ease; position: relative; }
.avatar-circle:hover { opacity: 0.9; transform: scale(1.04); box-shadow: 0 6px 20px rgba(0,0,0,0.2); }
.avatar-circle::after { content: '\f030'; font-family: 'Font Awesome 6 Free'; font-weight: 900; position: absolute; inset: 0; background: rgba(11, 76, 111, 0.4); color: white; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; opacity: 0; transition: all 0.3s ease; backdrop-filter: blur(2px); }
...
.status-dot { position: absolute; bottom: 8px; right: 8px; width: 16px; height: 16px; background: #22C55E; border: 3px solid white; border-radius: 50%; z-index: 3; }
...
.stat-item strong { font-size: 1.8rem; font-weight: 900; color: #0B4C6F; line-height: 1; }
.stat-item span { font-size: 0.7rem; font-weight: 700; color: #94A3B8; text-transform: uppercase; letter-spacing: 0.06em; margin-top: 4px; }
...
.banner-upload { height: 160px; background: linear-gradient(135deg, #071E38 0%, #0B4C6F 100%); background-size: cover; background-position: center; cursor: pointer; display: flex; align-items: center; justify-content: center; position: relative; overflow: hidden; }
