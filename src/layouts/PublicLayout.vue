...
const menuRef = ref(null); // Referencia para detectar clicks fuera
...
const goToProfile = () => {
  ...
  if (user.value.role === 'profesional') {
    router.push('/professional/profile'); // Ajusta si la ruta es distinta
  } else {
...
.dropdown-menu li { 
  ...
  padding: 10px 16px; font-size: 0.9rem; color: #4b5563; 
...
@media (max-width: 768px) {
  .nav-links { display: none; } /* En móvil se recomienda un menú hamburguesa aparte */
}
</style>